<?php
/**
 * Keywords Automation Dashboard - Tags Management
 * 
 * This file directly includes the TagController to handle the tags page.
 */
...
// Create and run the TagController
try {
    $controller = new \Controllers\TagController();
    $controller->index();
} catch (Exception $e) {
