 ...
 * 
 * This file directly includes the KeywordController to handle the request.
 */
...
// Create and run the KeywordController
try {
    $controller = new \Controllers\KeywordController();
    
    // Determine which method to call based on request method
